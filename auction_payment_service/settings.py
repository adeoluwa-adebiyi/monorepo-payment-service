"""
Django settings for auction_payment_service project.
...
SECRET_KEY = '!$jk+#8v=b4vh2tes!gr23@jql^x7df@o0s2d!yse*@9-kndhz'
...
ROOT_URLCONF = 'auction_payment_service.urls'
...
WSGI_APPLICATION = 'auction_payment_service.wsgi.application'
